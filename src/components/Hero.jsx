      ...
      <div className="container">
        <div className="mt-[50px] md:mt-20 text-center">
          ...
          <div className="mt-8 lg:mt-[100px] relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 bg-gradient-to-r from-white-97 via-white-97/80 to bg-transparent w-24 h-full z-10 pointer-events-none" />
            <div className="absolute top-0 right-0 bg-gradient-to-l from-white-97 via-white-97/80 to bg-transparent w-24 h-full z-10 pointer-events-none" />
          </div>
        </div>
